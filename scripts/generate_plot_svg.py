...
for patch_id in ['combined-vsd', '22-vsd', '23-vsd']:
    tif_path = f'outputs/superres/nakhon/2026-04-05/{patch_id}_native.tif'
    with rasterio.open(tif_path) as src:
        ...
        for idx, row in gdf_proj.iterrows():
            ...
            # Calculate centroid in 0..1000 viewBox
